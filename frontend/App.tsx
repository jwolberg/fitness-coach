...
const styles = StyleSheet.create({
  ...
  brand: { fontSize: 34, fontWeight: '800', color: colors.text },
  selector: { flexDirection: 'row', gap: 10 },
  tab: { paddingVertical: 9, paddingHorizontal: 20, borderRadius: 24, borderWidth: 1, borderColor: colors.border },
  tabActive: { backgroundColor: colors.accent, borderColor: colors.accent },
  tabText: { color: colors.text, fontWeight: '600', fontSize: 26 },
  ...
  colScroll: { flex: 1 },
  colContent: { padding: 24, maxWidth: 820, width: '100%', alignSelf: 'center' },
  colHeading: { fontSize: 24, fontWeight: '700', color: colors.muted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 16 },
});
