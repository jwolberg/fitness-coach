...
const styles = StyleSheet.create({
  ...
  adherenceRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 },
  injury: { marginBottom: 8 },
  affects: { color: colors.muted, fontSize: 13, marginTop: 4, marginLeft: 2 },
  excluded: { color: colors.danger, fontSize: 13, marginTop: 6 },
  sessionRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 8 },
  sessionTitle: { color: colors.text, fontWeight: '600', minWidth: 150 },
  date: { color: colors.muted, fontSize: 12 },
  signal: { marginBottom: 10 },
  signalText: { color: colors.text, fontStyle: 'italic' },
